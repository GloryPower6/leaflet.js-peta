...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <span class="navbar-brand">Peta Pasarwajo</span>
                        ...
                        <form id="inputForm" action="./data/scripts/leaflet/update_marker.php" method="POST">
                            <fieldset id="formFieldSet" disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="inputName" autocomplete="off" value="" name="name">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Deskripsi</label>
                                    <input type="text" class="form-control form-control-sm" id="inputDesc" autocomplete="off" value="" name="description">
                                </div>
                                
                                <?php include_once $CONFIG["PATH"]["APP"] . "inc/components/div.select.icon.php"; ?>
    ...
    <script src="./assets/js/variables/batas-kecamatan-pasarwajo.js"></script>
    ...
    <script src="./assets/js/variables/layers_control.js"></script>
